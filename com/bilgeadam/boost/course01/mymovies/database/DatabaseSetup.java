...
public class DatabaseSetup {
	...
	// int success = stmt.executeUpdate("insert into movies (id, name, year) values
	// (1, 'kdslfjdk', 2022);");
	...
	private void createTableMovieRatings(Statement stmt) throws SQLException {
		int success = stmt.executeUpdate("DROP TABLE IF EXISTS movie_ratings CASCADE; " + " "
				+ "CREATE TABLE IF NOT EXISTS movie_ratings " + "( " + "    movie_id bigint NOT NULL, "
				+ "    user_id bigint NOT NULL, " + "    rating real NOT NULL, "
				+ "    rated_at timestamp WITHOUT TIME ZONE NOT NULL, " + "    PRIMARY KEY (movie_id, user_id), "
				+ "    CONSTRAINT movie_id FOREIGN KEY (movie_id) " + "        REFERENCES movies (id) MATCH SIMPLE "
				+ "        ON UPDATE NO ACTION " + "        ON DELETE NO ACTION " + "        NOT VALID, "
				+ "    CONSTRAINT user_id FOREIGN KEY (user_id) " + "        REFERENCES users (id) MATCH SIMPLE "
				+ "        ON UPDATE NO ACTION " + "        ON DELETE NO ACTION " + "        NOT VALID " + "); " + " "
				+ "ALTER TABLE movie_ratings " + "    OWNER to postgres; " + " "
	...
	private void createTableMovieTags(Statement stmt) throws SQLException {
		int success = stmt.executeUpdate("DROP TABLE IF EXISTS movie_tags CASCADE; " + " "
				+ "CREATE TABLE IF NOT EXISTS movie_tags " + "( " + "    movie_id bigint NOT NULL, "
				...
				+ "    CONSTRAINT tag_id FOREIGN KEY (tag_id) " + "        REFERENCES tags (id) MATCH SIMPLE "
				+ "        ON UPDATE NO ACTION " + "        ON DELETE NO ACTION, "
				+ "    CONSTRAINT user_id FOREIGN KEY (user_id) " + "        REFERENCES users (id) MATCH SIMPLE "
				+ "        ON UPDATE NO ACTION " + "        ON DELETE NO ACTION " + ") " + " "
				+ "TABLESPACE pg_default; " + " " + "ALTER TABLE movie_tags " + "    OWNER to postgres; " + " "
	...
	private void createTableMovieGenres(Statement stmt) throws SQLException {
		int success = stmt.executeUpdate("DROP TABLE IF EXISTS movie_genres CASCADE; " + " "
				+ "CREATE TABLE IF NOT EXISTS movie_genres " + "( " + "    movie_id bigint NOT NULL, "
				+ "    genre_id bigint NOT NULL, "
				+ "    CONSTRAINT movie_genres_pkey PRIMARY KEY (movie_id, genre_id), "
				+ "    CONSTRAINT movie_id FOREIGN KEY (movie_id) " + "        REFERENCES movies (id) MATCH SIMPLE "
				+ "        ON UPDATE NO ACTION " + "        ON DELETE NO ACTION, "
				+ "    CONSTRAINT genre_id FOREIGN KEY (genre_id) " + "        REFERENCES genres (id) MATCH SIMPLE "
				+ "        ON UPDATE NO ACTION " + "        ON DELETE NO ACTION " + ") " + " "
				+ "TABLESPACE pg_default; " + " " + "ALTER TABLE movie_genres " + "    OWNER to postgres; " + " "
	...
	private void createTableGenres(Statement stmt) throws SQLException {
		int success = stmt.executeUpdate("DROP TABLE IF EXISTS genres CASCADE; " + "CREATE TABLE IF NOT EXISTS genres "
				+ "( " + "    id bigint NOT NULL, " + "    genre text NOT NULL, " + "    PRIMARY KEY (id) " + "); "
	...
	private void createTableLinks(Statement stmt) throws SQLException {
		int success = stmt.executeUpdate("DROP TABLE IF EXISTS links CASCADE; " + "CREATE TABLE IF NOT EXISTS links "
				+ "( " + "    id bigint NOT NULL, " + "    imdb text NOT NULL, " + "    tmdb text NOT NULL, "
				+ "    PRIMARY KEY (id) " + "); " + "ALTER TABLE links OWNER to postgres; "
	...
	private void createTableUsers(Statement stmt) throws SQLException {
		int success = stmt.executeUpdate("DROP TABLE IF EXISTS users CASCADE; " + "CREATE TABLE IF NOT EXISTS users "
	...
	private void createTableTags(Statement stmt) throws SQLException {
		int success = stmt.executeUpdate("DROP TABLE IF EXISTS tags CASCADE; " + "CREATE TABLE IF NOT EXISTS tags "
				+ "( " + "    id bigint NOT NULL, " + "    tag text NOT NULL, " + "    PRIMARY KEY (id) " + "); "
	...
	private void createTableMovies(Statement stmt) throws SQLException {
		int success = stmt.executeUpdate("DROP TABLE IF EXISTS movies CASCADE; " + "CREATE TABLE IF NOT EXISTS movies "
				+ "( " + "    id bigint NOT NULL, " + "    name text NOT NULL, " + "    year integer NOT NULL, "
				+ "    imdb_id text, " + "    PRIMARY KEY (id) " + "); " + "ALTER TABLE movies OWNER to postgres; "
	...
	private void createRole(Statement stmt) throws SQLException {
		int success = stmt.executeUpdate("DROP USER IF EXISTS omdb;" + "CREATE USER omdb WITH " + "    	LOGIN "
				+ "    	NOSUPERUSER " + "    	NOCREATEDB " + "    	NOCREATEROLE " + "    	INHERIT "
				+ "    	NOREPLICATION " + "    	CONNECTION LIMIT -1 " + "    	PASSWORD 'omdb';"
	...
	private void create(Statement stmt) throws SQLException {
		int success = stmt.executeUpdate("SET statement_timeout = 0; " + "SET lock_timeout = 0; "
				...
				+ "CREATE DATABASE mmdb " + "    WITH " + "    OWNER = postgres " + "    ENCODING = 'UTF8' "
